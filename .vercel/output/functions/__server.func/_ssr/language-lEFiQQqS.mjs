...
//#region node_modules/.nitro/vite/services/ssr/assets/language-lEFiQQqS.js
...
var PROJECTS = [
	...
	},
	{
		...
		metrics: [{
			...
			label: {
				en: "Target interactions",
				sk: "Cieľové interakcie"
			},
			value: "500"
		}],
		title: {
...
var JOBS = [
	...
	},
	{
		...
		role: {
			...
			sk: "Operátor vo výrobe"
		},
		org: "FYSAM Auto Decorative Slovakia s.r.o.",
		place: {
			en: "Veľký Krtíš, Slovakia",
			sk: "Veľký Krtíš, Slovensko"
		},
		note: {
	...
	},
	{
		period: "2018 – 2020",
		role: {
			en: "External quality control, automotive",
			sk: "Externá kontrola kvality pre automotive"
		},
		org: "Naro24h",
		place: {
			en: "Germany",
	...
	},
	{
		period: "2016 – 2018",
		role: {
			en: "Picker, packer, claims",
			sk: "Picker, packer, reklamácie"
		},
		org: "VF Corp. Praha",
		place: {
			en: "Czech Republic",
	...
	},
	{
		period: "2008 – 2009",
		role: {
			en: "Warehouse operative (UPS site)",
			sk: "Skladník (pobočka UPS)"
		},
...
var SKILL_GROUPS = [
	...
	},
	{
		...
		items: [
			{
				en: "Automotive quality",
				sk: "Kvalita v automotive"
			},
			{
				en: "Logistics",
				sk: "Logistika"
			...
			{
				en: "CO₂ welding ticket",
				sk: "Zváračský preukaz CO₂"
			},
			{
				en: "Line production",
				sk: "Linková výroba"
...
var copy = {
	en: {
		...
		thesis: {
			...
			sphereBody: "Raw intelligence. Dark, powerful, opaque. It is dynamic, rapidly evolving, and inherently non-deterministic. It moves at breakneck velocity.",
			cubeTitle: "The wireframe cube",
			cubeBody: "Guardrails. Structured, transparent, rigid. Adaptive security and governance — visible boundaries, compliance parameters, control points.",
		...
		about: {
			...
			body: ["I am a responsible, versatile worker with deep international experience in logistics, quality control, and automotive manufacturing. Alongside the practical work I am actively studying modern IT — cloud platforms, Microsoft Fabric, Azure, and the foundations of data analysis and agentic systems.", "The through-line is the same on a press line and in a pipeline: flexibility, reliability, precision, and a willingness to learn the next tool. I work well in a team and I hold a CO₂ welding ticket."]
		},
		contact: {
			kicker: "Contact",
			title: "Let’s talk",
	...
	sk: {
		...
		stats: [
			...
			{
				value: "18+",
				label: "Rokov v prevádzke"
			},
			{
				value: "4",
				label: "Pracovné jazyky"
			},
			{
				value: "2026",
				label: "Agentická téza"
			}
		],
		thesis: {
			kicker: "Značka",
			title: "Guľa a kocka",
			sphereTitle: "Guľa",
			sphereBody: "Surová inteligencia. Tmavá, silná, nepriehľadná. Je dynamická, rýchlo sa vyvíja a je vo svojej podstate nesto-chastická. Pohybuje sa extrémnou rýchlosťou.",
			cubeTitle: "Drôtená kocka",
			cubeBody: "Zábradlia. Štruktúrovaná, priehľadná, pevná. Adaptívna bezpečnosť a riadenie — viditeľné hranice, parametre súladu, kontrolné body.",
		...
		about: {
			...
			body: ["Som zodpovedný a všestranný pracovník s bohatými medzinárodnými skúsenosťami v logistike, kontrole kvality a automobilovej výrobe. Popri praktickej práci sa aktívne vzdelávam v moderných IT — cloudové platformy, Microsoft Fabric, Azure a základy dátovej analýzy a agentických systémov.", "Spojovacia linka je rovnaká na lise aj v pipeline: flexibilita, spoľahlivosť, presnosť a ochota učiť sa ďalší nástroj. Som tímový hráč a mám zváračský preukaz na CO₂."]
		},
		contact: {
			kicker: "Kontakt",
			title: "Ozvite sa",
...
//#endregion
export { PROJECTS as a, t as c, LanguageProvider as i, useLanguage as l, JOBS as n, SKILL_GROUPS as o, LANGUAGES as r, getProject as s, CONTACT as t };
